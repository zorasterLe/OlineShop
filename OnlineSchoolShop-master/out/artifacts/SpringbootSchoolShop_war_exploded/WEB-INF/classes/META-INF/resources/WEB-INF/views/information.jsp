        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                    ...
                    <div class="form-group">
                        <label for="card" class="col-sm-2 control-label">银行卡号</label>
                        <div class="col-sm-9">
            ...
            <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
                <div class="tab-content">
                        <table class="table" cellpadding="6" cellspacing="1">
                            ...
                            <tr>
                                <th style="border: 0px solid transparent" class="tl">银行卡号</th>
                                <td style="border: 0px solid transparent" class="tr" id="cardVal">${user.getCard()}</td>
                            </tr>
