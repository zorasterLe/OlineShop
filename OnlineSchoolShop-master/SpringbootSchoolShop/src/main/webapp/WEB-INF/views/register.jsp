...
<body style="background: url(${pageContext.request.contextPath}/image/registerb.jpg)">
<div id="main" class="container">
    ...
    <div class="login">
        <div class="row">
            <div class="col-md-6">
                <img src="${pageContext.request.contextPath}/image/register1.png" width="450" height="450" alt="" style="margin-left: 40px;">
            </div>
            <div class="col-md-5 form-register">
                <div>
                    ...
                    <form class="form-horizontal" id="form" action="${pageContext.request.contextPath}/registerresult"
                        ...
                        <div class="form-group">
                            <!-- <label for="inputTel" class="col-sm-2 control-label">银行卡号</label> -->
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="card"
                                       name="card" placeholder="银行卡号">
                            </div>
                        </div>
                        <div class="form-group">
