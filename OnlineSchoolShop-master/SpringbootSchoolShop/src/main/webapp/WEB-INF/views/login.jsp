...
<body onload="input_value()" style="background: url(${pageContext.request.contextPath}/image/loginb.jpg)">
	<div id="main" class="container">
		...
		<div class="login">
			<div class="row">
				<div class="col-md-6">
					<img src="./image/login1.png" alt="" width="600" height="400" style="margin-left:-40px;margin-top:30px;">
				</div>
				<div class="col-md-5 form-login">
					<div>
						...
						<form class="form-horizontal" id="form2" action="${pageContext.request.contextPath}/loginconfirm" method="post">
							...
							<div style="margin-left:80px;color:#ff0000;">
							</div>
